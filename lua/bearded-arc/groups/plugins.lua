...
function M.get(colors)
	return {
		...
		TelescopePromptBorder = { fg = colors.border, bg = colors.bg_float },
		...
		WhichKeyBorder = { fg = colors.border, bg = colors.bg_float },
		...
		NoicePopupBorder = { fg = colors.border, bg = colors.bg_float },
